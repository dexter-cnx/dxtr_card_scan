...
void main() {
  testWidgets('CardScanTheme resolves from ThemeData extensions', (
    tester,
  ) async {
    const expected = CardScanTheme(
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Builder(
          builder: (context) {
            resolved = CardScanTheme.of(context);
  ...
  test('theme interpolation carries Camera, controls and Gallery styles', () {
    const a = CardScanTheme();
    const b = CardScanTheme(
